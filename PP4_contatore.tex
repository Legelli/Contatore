...
\begin{align*}
	C_1 = 33 &\longrightarrow \overline{p_1} = \SI{0.44 \pm 0.12}{} \\ %Prima di fare i conti voglio confrontarmi con voi (per la prima li ho fatti tutti)
...
\begin{align*}
	& \overline{p_1} = \SI{0.55 \pm 0.14}{} \\ %Prima di fare i conti voglio confrontarmi con voi (ho usato una sola probabilità)
