...
\]
Secondo il criterio di massima verosimiglianza otteniamo che il punto di massimo della funzione precedente corrisponde alla nostra stima di $r_\text{best}$, ossia $r_\text{best} = 1.02 \pm 0.03$.
...
\]
e ricaviamo $\chi^2 = 4.51$. Considerando (per quanto già detto sopra) un numero di gradi di libertà pari a $\nu = 4$ concludiamo che entrambe le frazioni sono compatibili con il modello descritto da (\ref{eq:frazione}).
...
\label{}
\centering
\includegraphics[scale=0.7]{lollo.eps}
\end{figure}
